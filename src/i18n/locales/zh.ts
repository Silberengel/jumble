export default {
  translation: {
    ...
    'Personal lists hub intro':
      '静音列表、关注的人、NIP-51 书签、置顶、兴趣主题（kind 10015）、NIP-30 用户表情列表（kind 10030）与表情包（kind 30030）。网页书签（NIP-B0，kind 39701）另计：可在文章侧栏保存，或在「咒语」里打开书签流同时查看笔记书签与网页书签。',
    'Mute list': '静音列表',
    'Following list': '关注列表',
    ...
    'User emoji sets hint':
      '坐标格式：30030:<64 位十六进制公钥>:<d 标签>，通常为本账户在「表情包」页面创建的集合。',
    ...
    'Delete emoji set confirm':
      '将发送删除请求（kind 5）。接受的中继会移除该集合；其他客户端可能仍显示缓存副本。',
