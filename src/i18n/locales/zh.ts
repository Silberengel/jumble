export default {
  translation: {
    ...
    Pictures: "图片",
    "Picture note": "图片笔记",
    "A special note for picture-first clients like Olas": "一种可以在图片优先客户端 (如 Olas) 中显示的特殊笔记",
    ...
    "This is a private key. Do not share it with anyone. Keep it safe and secure. You will not be able to recover it if you lose it.": "这是私钥，请勿与他人分享。请妥善保管，否则将无法找回。",
    Edit: "编辑",
    Save: "保存",
    "Display Name": "昵称",
    Bio: "简介",
    ...
    "Quick zap": "快速打闪",
    "If enabled, you can zap with a single click. Click and hold for custom amounts": "如果启用，您单击即可打闪。长按以设置自定义金额",
    All: "全部",
    Reactions: "互动",
    Zaps: "打闪",
    Boosts: "助推",
    ...
    "Your donation helps me maintain Imwald and make it better! 😊": "您的捐赠帮助我维护 Imwald 并使其更好！😊",
    ...
    Preview: "预览",
    "You are about to publish an event signed by [{{eventAuthorName}}]. You are currently logged in as [{{currentUsername}}]. Are you sure?": "您即将发布一条由 [{{eventAuthorName}}] 签名的事件。您当前以 [{{currentUsername}}] 登录。确定吗？",
    "Platinum Sponsors": "白金赞助商",
    From: "来自",
    "Comment on": "评论于",
    "View on njump.me": "在 njump.me 上查看",
    "Hide content from untrusted users": "隐藏不受信任用户的内容",
    "Only show content from your followed users and the users they follow": "仅显示您关注的用户及其关注的用户的内容",
    "Followed by": "关注者",
    ...
    Balance: "余额",
    characters: "字符",
    translateApiKeyDescription: "您可以在任何支持 LibreTranslate 的地方使用此 API key。服务地址是 {{serviceUrl}}",
    "Top up": "充值",
    ...
    "Are you sure you want to reset your API key? This action cannot be undone.": "您确定要重置您的 API key？此操作无法撤销。",
    Warning: "警告",
    "Errors & warnings": "Errors & warnings",
    "Your current API key will become invalid immediately, and any applications using it will stop working until you update them with the new key.": "您当前的 API key 将立即失效，任何使用它的应用程序将停止工作，直到您用新 key 更新它们。",
    ...
    "Click continue to hide {type} from untrusted users.": "点击继续隐藏来自不受信任用户的{{type}}。",
    "Trusted users include people you follow and people they follow.": "受信任的用户包括您关注的人和他们关注的人。",
    Continue: "继续",
    ...
    "You need to add at least one blossom server in order to upload media files.": "您需要添加至少一个 Blossom 服务器才能上传媒体文件。",
    ...
    "Unlike regular notes, polls are not widely supported and may not display on other clients.": "与普通帖子不同，投票功能暂时没有得到广泛的支持，可能无法在其他客户端中显示。",
    ...
    "You have {{count}} read relays. Most clients only use 2-4 relays, setting more is unnecessary.": "您有 {{count}} 个读取中继。大多数客户端只使用 2-4 个中继，设置更多是不必要的。",
    "You have {{count}} write relays. Most clients only use 2-4 relays, setting more is unnecessary.": "您有 {{count}} 个写入中继。大多数客户端只使用 2-4 个中继，设置更多是不必要的。",
    ...
    "Pinned notes hint": "置顶笔记：在笔记菜单（⋯）中选择置顶到资料。置顶会显示在你的个人资料上。",
