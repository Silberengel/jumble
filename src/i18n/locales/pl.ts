export default {
  translation: {
    ...
    Search: "Wyszukaj",
    "The relays you are connected to do not support search": "Podłączone transmitery nie obsługują wyszukiwania",
    "Show more...": "Więcej...",
    ...
    "A special note for picture-first clients like Olas": "Publikacja ze zdjęciami i opisem dla klientów takich jak Olas",
    ...
    "This is a private key. Do not share it with anyone. Keep it safe and secure. You will not be able to recover it if you lose it.": "Jest to klucz prywatny. Nie należy go nikomu udostępniać. Przechowuj go w bezpiecznym miejscu. W przypadku jego utraty nie będzie można go odzyskać.",
    Edit: "Edytuj",
    Save: "Zapisz",
    ...
    "If enabled, you can zap with a single click. Click and hold for custom amounts": "Jeśli włączysz tę opcję, będzie można wysyłać zapa jednym kliknięciem. Naciśnij i przytrzymaj, aby wprowadzić inną kwotę",
    All: "Wszystkie",
    Reactions: "Odzewy",
    Zaps: "Zapy",
    Boosts: "Boosty",
    ...
    "Your donation helps me maintain Imwald and make it better! 😊": "Twoja darowizna pomoże mi utrzymać i ulepszać Imwald! 😊",
    ...
    Preview: "Podgląd",
    "You are about to publish an event signed by [{{eventAuthorName}}]. You are currently logged in as [{{currentUsername}}]. Are you sure?": "Zaraz opublikujesz zdarzenie podpisane przez [{{eventAuthorName}}]. Obecnie jesteś zalogowany jako [{{currentUsername}}]. Czy jesteś pewien?",
    ...
    "Only show content from your followed users and the users they follow": "Pokaż tylko treści od użytkowników, których obserwujesz i ich obserwowanych",
    ...
    Balance: "Saldo",
    characters: "znaków",
    translateApiKeyDescription: "Ten klucz API możesz używać wszędzie tam, gdzie obsługiwane jest LibreTranslate. Adres usługi to {{serviceUrl}}",
    "Top up": "Doładuj",
    ...
    "Are you sure you want to reset your API key? This action cannot be undone.": "Czy na pewno chcesz zresetować swój klucz API? Ta akcja jest nieodwracalna.",
    Warning: "Ostrzeżenie",
    "Errors & warnings": "Errors & warnings",
    "Your current API key will become invalid immediately, and any applications using it will stop working until you update them with the new key.": "Twój obecny klucz API stanie się nieaktywny natychmiast, a wszystkie aplikacje korzystające z niego przestaną działać, dopóki nie zaktualizujesz ich nowym kluczem.",
    ...
    "Currently hiding {type} from untrusted users.": "Obecnie ukrywasz {{type}} od nieznanych użytkowników.",
    ...
    "Click continue to hide {type} from untrusted users.": "Kliknij kontynuuj, aby ukryć {{type}} od nieznanych użytkowników.",
    ...
    "You need to add at least one blossom server in order to upload media files.": "Musisz dodać przynajmniej jeden serwer Blossom, aby móc przesyłać pliki multimedialne.",
    ...
    "Unlike regular notes, polls are not widely supported and may not display on other clients.": "W przeciwieństwie do zwykłych notatek, ankiety nie są szeroko obsługiwane i mogą nie wyświetlać się w innych klientach.",
    ...
    "Relay URLs (optional, comma-separated)": "Adresy URL transmiterów (opcjonalne, oddzielone przecinkami)",
    ...
    "After changing emojis, you may need to refresh the page": "Po zmianie emoji może być konieczne odświeżenie strony",
    ...
    "You have {{count}} write relays. Most clients only use 2-4 relays, setting more is unnecessary.": "You have {{count}} write relays. Most clients only use 2-4 relays, setting more is unnecessary.",
    ...
    "Deletion request sent to {{count}} relays": "Żądanie usunięcia wysłano do {{count}} transmiterów",
    ...
    Disconnect: "Odłącz",
    "Set up your wallet to send and receive sats!": "Skonfiguruj swój portfel, aby wysyłać i odbierać satsy!",
    "Set up": "Skonfiguruj",
