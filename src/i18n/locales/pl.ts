export default {
  translation: {
    ...
    "read relays description": "Transmitery odczytu służą do wyszukiwania zdarzeń dotyczących użytkownika. Inni użytkownicy będą publikować wpisy, które chcą, abyś zobaczył, w transmiterach odczytu.",
    "write relays description": "Transmitery zapisu służą do publikowania wydarzeń. Inni użytkownicy będą wyszukiwać zdarzenia z transmiterów zapisu.",
    ...
    "Show this category expanded on payment method lists; other categories collapse behind an accordion.": "Pokazuj tę kategorię rozwiniętą na listach metod płatności; pozostałe zwijaj w akordeonie.",
    ...
    "Successfully republish to your write relays": "Pomyślnie ponownie opublikowano na twoich transmiterach zapisu",
    "Failed to republish to your write relays: {{error}}": "Nie udało się ponownie opublikować na twoich transmiterach zapisu: {{error}}",
    "Successfully republish to relay set: {{name}}": "Pomyślnie ponownie opublikowano do zestawu transmiterów: {{name}}",
    "Failed to republish to relay set: {{name}}. Error: {{error}}": "Nie udało się ponownie opublikować do zestawu transmiterów: {{name}}. Błąd: {{error}}",
    "Successfully republish to relay: {{url}}": "Pomyślnie ponownie opublikowano do transmitera: {{url}}",
    "Failed to republish to relay: {{url}}. Error: {{error}}": "Nie udało się ponownie opublikować do transmitera: {{url}}. Błąd: {{error}}",
    "Write relays": "Transmitery zapisu",
    "n more boosts": "{{count}} more boosts",
    FollowListNotFoundConfirmation: "Lista obserwowanych nie została znaleziona. Czy chcesz utworzyć nową? Jeśli wcześniej obserwowałeś użytkowników, proszę NIE potwierdzaj, ponieważ ta operacja spowoduje utratę poprzedniej listy obserwowanych.",
    MuteListNotFoundConfirmation: "Lista wyciszonych nie została znaleziona. Czy chcesz utworzyć nową? Jeśli wcześniej wyciszałeś użytkowników, proszę NIE potwierdzaj, ponieważ ta operacja spowoduje utratę poprzedniej listy wyciszonych.",
    ...
    "Your current relay configuration may not be optimal. This could make it difficult for others to find your posts and may result in incomplete notifications.": "Twoja obecna konfiguracja transmiterów może nie być optymalna. To może utrudnić innym znalezienie Twoich postów i może skutkować niekompletnymi powiadomieniami.",
    ...
    "No reviews yet. Be the first to write one!": "Jeszcze brak opinii. Bądź pierwszym, który napisze!",
