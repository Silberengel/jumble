export default {
  translation: {
    ...
    calendarNip52DayIndicesHint: "Les balises D (NIP-52) indiquent des jours civils UTC entiers (indice de jour Unix) pour indexer les événements horodatés ; plusieurs valeurs couvrent une plage de plusieurs jours.",
    ...
    "read relays description": "Les relais de lecture permettent de consulter vos événements. D'autres utilisateurs y publieront les événements à afficher sur vos relais de lecture.",
    "write relays description": "Les relais d'écriture servent à publier vos événements. D'autres utilisateurs rechercheront vos événements via ces relais.",
    "read & write relays notice": "Il est recommandé de maintenir entre 2 et 4 serveurs de lecture et d'écriture.",
    "Tor & I2P": "Tor & I2P",
    ...
    "Enter the password to decrypt your ncryptsec": "Entrez le mot de passe pour décrypter votre ncryptsec",
    Back: "Retour",
    ...
    "Show this category expanded on payment method lists; other categories collapse behind an accordion.": "Afficher cette catégorie dépliée dans les listes de paiement ; les autres sont repliées dans un accordéon.",
    ...
    "Are you sure you want to unfollow this user?": "Êtes-vous sûr de vouloir arrêter de suivre cet utilisateur ?",
    "Seen on": "Vu sur",
    ...
    "Paste or drop media files to upload": "Coller ou déposer des fichiers multimédias à télécharger",
    Preview: "Aperçu",
    ...
    "Failed to republish to your write relays: {{error}}": "Échec du republishing vers vos relais d’écriture : {{error}}",
    "Successfully republish to relay set: {{name}}": "Republié avec succès vers le groupe de relais : {{name}}",
    "Failed to republish to relay set: {{name}}. Error: {{error}}": "Échec du republishing vers le groupe de relais : {{name}}. Erreur : {{error}}",
    "Successfully republish to relay: {{url}}": "Republié avec succès vers le relais : {{url}}",
    "Failed to republish to relay: {{url}}. Error: {{error}}": "Échec du republishing vers le relais : {{url}}. Erreur : {{error}}",
    "Write relays": "Relais d’écriture",
    "n more boosts": "{{count}} more boosts",
    FollowListNotFoundConfirmation: "Liste de suivi non trouvée. Voulez-vous en créer une nouvelle ? Si vous avez suivi des utilisateurs auparavant, veuillez NE PAS confirmer car cette opération vous fera perdre votre liste de suivi précédente.",
    MuteListNotFoundConfirmation: "Liste de mise en sourdine non trouvée. Voulez-vous en créer une nouvelle ? Si vous avez mis en sourdine des utilisateurs auparavant, veuillez NE PAS confirmer car cette opération vous fera perdre votre liste de mise en sourdine précédente.",
    ...
    "Your current relay configuration may not be optimal. This could make it difficult for others to find your posts and may result in incomplete notifications.": "Votre configuration de relais actuelle pourrait ne pas être optimale. Cela pourrait rendre difficile pour les autres de trouver vos publications et pourrait entraîner des notifications incomplètes.",
    ...
    "Hide content mentioning muted users": "Masquer le contenu mentionnant des utilisateurs masqués",
    "This note mentions a user you muted": "Cette note mentionne un utilisateur que vous avez masqué",
    Filter: "Filtre",
    ...
    "No reviews yet. Be the first to write one!": "Pas encore d’avis. Soyez le premier à en écrire un !",
    ...
    "You will not be able to send zaps to others.": "Vous ne pourrez plus envoyer de zaps aux autres.",
    ...
    "Full-text search local archive description": "Matched in your publication cache or event archive on this device. Index relays may not have ingested the note yet.",
    ...
    "readOnlySession.cannotPublish": "readOnlySession.cannotPublish",
