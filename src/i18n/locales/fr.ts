export default {
  translation: {
    ...
    "A special note for picture-first clients like Olas": "Une note spéciale pour les clients axés sur l'image comme Olas",
    ...
    "This is a private key. Do not share it with anyone. Keep it safe and secure. You will not be able to recover it if you lose it.": "Ceci est une clé privée. Ne la divulguez à personne. Gardez-la en sécurité. Vous ne pourrez pas la récupérer en cas de perte.",
    Edit: "Modifier",
    Save: "Enregistrer",
    ...
    "If enabled, you can zap with a single click. Click and hold for custom amounts": "Si activé, vous pouvez zap avec un seul clic. Cliquez et maintenez pour des montants personnalisés",
    All: "Tous",
    Reactions: "Réactions",
    Zaps: "Zaps",
    Boosts: "Boosts",
    ...
    "Your donation helps me maintain Imwald and make it better! 😊": "Votre don m'aide à maintenir Imwald et à l'améliorer ! 😊",
    ...
    translateApiKeyDescription: "Vous pouvez utiliser cette clé API ailleurs qui prend en charge LibreTranslate. L’URL du service est {{serviceUrl}}",
    "Top up": "Recharger",
    ...
    "Currently hiding {type} from untrusted users.": "Actuellement, les {{type}} des utilisateurs non fiables sont masquées.",
    ...
    "Trusted users include people you follow and people they follow.": "Les utilisateurs de confiance incluent les personnes que vous suivez et les personnes qu’elles suivent.",
    Continue: "Continuer",
    ...
    "You need to add at least one blossom server in order to upload media files.": "Vous devez ajouter au moins un serveur Blossom pour pouvoir télécharger des fichiers multimédias.",
    ...
    "Unlike regular notes, polls are not widely supported and may not display on other clients.": "Contrairement aux notes régulières, les sondages ne sont pas largement pris en charge et peuvent ne pas s'afficher sur d'autres clients.",
    ...
    "Relay URLs (optional, comma-separated)": "URLs de relais (optionnel, séparées par des virgules)",
    ...
    "After changing emojis, you may need to refresh the page": "Après avoir modifié les émojis, vous devrez peut-être actualiser la page",
    "Too many read relays": "Trop de relais de lecture",
    "Too many write relays": "Trop de relais d'écriture",
    "You have {{count}} read relays. Most clients only use 2-4 relays, setting more is unnecessary.": "Vous avez {{count}} relais de lecture. La plupart des clients n'utilisent que 2 à 4 relais, en configurer plus est inutile.",
    "You have {{count}} write relays. Most clients only use 2-4 relays, setting more is unnecessary.": "Vous avez {{count}} relais d'écriture. La plupart des clients n'utilisent que 2 à 4 relais, en configurer plus est inutile.",
    ...
    "See extra info for each notification": "Voir des infos supplémentaires pour chaque notification",
