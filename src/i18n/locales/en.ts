export default {
  translation: {
    ...
    userStatusNip38Hint:
      'NIP-38 live statuses (kind 30315). Shown next to your name on posts and your profile.',
    ...
    'Open Advanced to adjust mention recipients':
      'Open Advanced to adjust who receives this message.',
    ...
    hiddenNetworkRelaysIntro:
      'Tor (.onion) and I2P (.i2p) relay URLs need a local SOCKS proxy. Imwald routes them through a loopback bridge when you run npm run dev locally.',
    hiddenNetworkRelaysWebLimit:
      'The public website cannot reach hidden-network relays directly. Use clearnet relay URLs here, or run npm run dev locally with Tor/I2P.',
    ...
    'liveActivities.openJoinPageTitle':
      'Open the join page in a new tab (e.g. zap.stream or the room site)',
    ...
    'Session relays tab description':
      'Relay logic for this session: preset relays and scored random relays used to prefer faster, proven relays when adding random relays to publish.',
    'Session relays preset working': 'Built-in preset relays',
    'Session relays preset working hint':
      'URLs from the app’s built-in relay lists (fast read/write, searchable, starter favorites). Shown for reference — not a live health check.',
    ...
    'cacheImport.fileHint':
      'One JSON event per line (NDJSON). Duplicate event ids in the same import are skipped.',
    ...
    'Advanced lab translation languages empty':
      'Translate service returned no languages (check Docker / LibreTranslate).',
    'Advanced lab translation languages error':
      'Could not load languages from the translate service.',
    ...
    'Advanced lab tb citationsHint':
      'Kinds 30–33. Inserts `[[citation::type::nevent…]]` (Markdown & AsciiDoc).',
    ...
    'Advanced lab tb adocLevel0WithHeader':
      'Minimal header (title, author, revision, description, keywords, first section)',
    ...
    'Library relay search timed out':
      'Relay search timed out. Showing matches from your local library cache when available.',
    ...
    articleDTagDefaultHint:
      'Optional. If empty, the d-tag defaults to a type-specific prefix plus a Unix timestamp (seconds), e.g. longform-article-…, wiki-article-…, nostr-specification-…, publication-content-….',
    Audio: 'Audio',
    Author: 'Author',
    ...
    'readOnlySession.hint':
      'You are logged in with a public key (npub) only. Publishing and signing are disabled in this browser.',
    ...
    'readOnlySession.cannotPublish':
      'Cannot publish in read-only mode. Log in with a private key or signer.',
