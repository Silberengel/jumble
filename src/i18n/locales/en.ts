export default {
  translation: {
    ...
    'Zap dialog other payment hint':
      'Tap a link to open PayPal or copy an address. Lightning tips use the button below.',
    ...
    'Tip notice success only note':
      'Only if you already sent a tip successfully (Lightning or another payment method).',
    ...
    hiddenNetworkBrowserOnlyNotice:
      'Use npm run dev locally to connect to .onion and .i2p relays.',
    ...
    'nip07.extensionKeyMismatch':
      "Your browser extension is using a different key on this tab. Switch to the matching key in the extension, reload the page to apply your extension's current selection, or use the other action on this message to log in with the key currently selected in your extension.",
