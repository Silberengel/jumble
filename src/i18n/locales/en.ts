export default {
  translation: {
    ...
    "Wiki Redirect": "Wiki Redirect",
    "Redirect: “{{slug}}”": "Redirect: “{{slug}}”",
    "This name redirects to:": "This name redirects to:",
    "Unknown target": "Unknown target",
    "Accepted a merge request": "Accepted a merge request",
    "Merged version:": "Merged version:",
    Merged: "Merged",
    "Merge request": "Merge request",
    "Into article:": "Into article:",
    "Proposed version:": "Proposed version:",
    "The author defers to another version:": "The author defers to another version:",
    "Forked from:": "Forked from:",
    "Merge requests ({{count}})": "Merge requests ({{count}})",
    "Fork this article": "Fork this article",
    "Create merge request": "Create merge request",
    "Defer to this version": "Defer to this version",
    "Deferred to this version": "Deferred to this version",
    "Create redirect to this article": "Create redirect to this article",
    ...
    "Create your own version of this article. It keeps the same name so it competes as an alternative version.":
      "Create your own version of this article. It keeps the same name so it competes as an alternative version.",
    Content: "Content",
    "Publish fork": "Publish fork",
    "Content cannot be empty": "Content cannot be empty",
    "Fork published": "Fork published",
    ...
    "This article is not a fork, so it cannot be merged anywhere.":
      "This article is not a fork, so it cannot be merged anywhere.",
    "Merge request sent": "Merge request sent",
    "Point an alternative name at this article so searches for it land here.":
      "Point an alternative name at this article so searches for it land here.",
    "Name to redirect": "Name to redirect",
    "e.g. BTC": "e.g. BTC",
    "Normalized: {{slug}}": "Normalized: {{slug}}",
    "Publish redirect": "Publish redirect",
    "Redirect published": "Redirect published",
    "Enter a name to redirect": "Enter a name to redirect",
    ...
    "Working…": "Working…",
    "Merge request rejected": "Merge request rejected",
    "This merge request is incomplete.": "This merge request is incomplete.",
    "Could not load the proposed version.": "Could not load the proposed version.",
    "Merge request accepted": "Merge request accepted",
    About: "About",
    "Download the Android app": "Download the Android app",
    "New Note": "New Note",
    Post: "Post",
    Feed: "Feed",
    ...
    "Waiting for Amber / signer…": "Waiting for Amber / signer…",
    "Please reload.": "Please reload.",
    "Connection failed. Please reload.": "Connection failed. Please reload.",
    ...
    "Paste a GIF URL, upload your own file, or search Tenor.": "Paste a GIF URL, upload your own file, or search Tenor.",
    "Opens Tenor in a new tab. Copy a GIF URL there, then paste it below.": "Opens Tenor in a new tab. Copy a GIF URL there, then paste it below.",
    "Emotions (up to 6)": "Emotions (up to 6)",
    "With at least one emotion your GIF is published as a reaction clip (kind 1090, browsable by emotion); without emotions it falls back to legacy kind 1063.": "With at least one emotion your GIF is published as a reaction clip (kind 1090, browsable by emotion); without emotions it falls back to legacy kind 1063.",
    "Reaction clip (kind 1090), content-addressed by the sha256 of its bytes.": "Reaction clip (kind 1090), content-addressed by the sha256 of its bytes.",
    "Reaction clip (kind 1090), content-addressed by the sha256 of its bytes. Emotions: {{emotions}}": "Reaction clip (kind 1090), content-addressed by the sha256 of its bytes. Emotions: {{emotions}}",
    ...
    "Uploading...": "Uploading...",
    "No GIFs found. Try searching or add your own. GIFs come from Nostr reaction clips (kind 1090) and kind 1063 (NIP-94) events on GIF relays.": "No GIFs found. Try searching or add your own. GIFs come from Nostr reaction clips (kind 1090) and kind 1063 (NIP-94) events on GIF relays.",
    ...
    "Session relay strikes hint": "Relays temporarily skipped after failures or rate-limit notices. Five read or publish failures → 3 minute skip. Rate-limit NOTICE → 10 minute cooldown (no strike count). Cache relays (kind 10432) always accrue failures.",
    ...
    "Library search field subject": "Subject",
    "Library search field subject placeholder": "e.g. mythology",
    "Library search field language": "Language",
    "Library search field language placeholder": "e.g. en, de",
    "Library search field identifier": "Identifier",
    "Library search field identifier placeholder": "e.g. isbn:… or openlibrary:…",
    ...
    "Library search field published from": "Published from",
    "Library search field until": "Until",
    ...
    "See the interactions": "See the interactions",
    "Peruse the publication": "Peruse the publication",
    "Save for offline reading": "Save for offline reading",
    "Saved — remove": "Saved — remove",
    "Download as EPUB": "Download as EPUB",
    "Publication action": "Publication action",
    "Go": "Go",
    "This catalog card has no nested reading content.": "This catalog card has no nested reading content.",
    ...
    "Publish this GIF to the Nostr GIF library (reaction clip when possible) and insert the URL into your post": "Publish this GIF to the Nostr GIF library (reaction clip when possible) and insert the URL into your post",
    ...
    "Create and award badge": "Create and award badge",
    "Create and award badge intro": "Define a NIP-58 badge (kind 30009), then award it to one or more people with a kind 8 event. Recipients can add it to their own profile badge list.",
    "Badge name": "Badge name",
    "Badge name placeholder": "e.g. Medal of Bravery",
    "Badge id (d tag)": "Badge id (d tag)",
    "Badge id placeholder": "e.g. bravery",
    "Badge id hint": "Stable unique id for this badge. Auto-filled from the name if left empty.",
    "Badge id (d tag) is required": "Enter a badge id (d tag) or a name.",
    "Badge description placeholder": "Optional: what this badge means",
    "Badge image hint": "Prefer a square image (about 1024×1024). Used for image and thumbnail tags.",
    "Award to (npubs)": "Award to (npubs)",
    "Award recipients placeholder": "npub1… or hex pubkeys, one per line",
    "Enter at least one recipient npub": "Enter at least one recipient (npub or hex pubkey).",
    "Invalid recipient npub": "Invalid recipient: {{token}}",
    "Publish definition and award": "Publish definition and award",
    "Badge created and awarded": "Badge published and awarded to {{count}} recipient(s)",
    "Badge award published hint": "Share these tags so recipients can add the badge to their profile list.",
    "Create another": "Create another",
    "Unclaimed badge awards": "Unclaimed badge awards",
    "Unclaimed badge awards intro": "Kind 8 awards for your pubkey that are not yet on your profile badge list. Claiming appends the badge and publishes the updated list.",
    "Claim badge": "Claim badge",
    "Badge claimed": "Badge claimed and list published",
    "Badge already on your list": "That badge is already on your list",
    "No unclaimed badge awards": "No unclaimed awards — everything found is already on your list.",
    "No badge awards found on relays": "No badge awards for you were found on connected relays.",
    ...
    "Search on Tenor": "Search on Tenor",
