export default {
  translation: {
    ...
    "Relay pulse active npubs hint": "Kind-0-Profile für npubs, die in der letzten Stunde auf deinen Lieblingsrelais auftauchten (gleiche Stichprobe wie Relay-Puls).",
    ...
    "Relay auth accepted (NIP-42)": "Das Relay hat die Authentifizierung akzeptiert (NIP-42): {{relay}}{{detailSuffix}}",
    ...
    "Create a calendar event and send an invite. The recipient will see the event with a join link.": "Kalendertermin erstellen und Einladung senden. Der Empfänger sieht den Termin mit einem Teilnahme-Link.",
    "Schedule a video call": "Videoanruf planen",
    "Create a calendar event and send kind 24 invites to each listed invitee.": "Kalendertermin erstellen und an jede eingetragene Person eine Kind-24-Einladung senden.",
    Invitees: "Eingeladene",
    "Paste nostr:npub1... or nostr:nprofile1... (one or more)": "nostr:npub1... oder nostr:nprofile1... einfügen (einer oder mehrere)",
    ...
    "Create a calendar event and send an invite. No video link — for real-life meetups, conferences, etc.": "Kalendertermin erstellen und Einladung senden. Ohne Video-Link – für reale Treffen, Konferenzen usw.",
    ...
    "Create a calendar event for a real-life meetup and send kind 24 invites to each invitee.": "Kalendertermin für ein reales Treffen erstellen und an jede Person eine Kind-24-Einladung senden.",
    ...
    readOnlySession: {"label":"Read-only","labelShort":"R/O","hint":"Browsing without a signing key. Sign in with an extension, nsec, or another method to post, react, and edit."},
    ...
    "A special note for picture-first clients like Olas": "Eine spezielle Notiz für bildfokussierte Clients wie Olas",
    ...
    "This is a private key. Do not share it with anyone. Keep it safe and secure. You will not be able to recover it if you lose it.": "Dies ist ein privater Schlüssel. Teile ihn mit niemandem. Bewahre ihn sicher auf. Du kannst ihn nicht wiederherstellen, falls du ihn verlierst.",
    Edit: "Bearbeiten",
    Save: "Speichern",
    ...
    "Add web URL to feed description": "Adds a card to this feed. Open the page from the card when you want to read, reply, react, or highlight.",
    "Add to feed": "Add to feed",
    "Open any https page in the side panel to reply, react, and discuss on Nostr.": "Beliebige https-Seite im Seitenpanel öffnen, um auf Nostr zu antworten, zu reagieren und zu diskutieren.",
    ...
    "If enabled, you can zap with a single click. Click and hold for custom amounts": "Wenn aktiviert, kannst du mit einem Klick zapen. Klicke und halte für individuelle Beträge",
    All: "Alle",
    ...
    "Your donation helps me maintain Imwald and make it better! 😊": "Deine Spende hilft mir, Imwald zu pflegen und zu verbessern! 😊",
    ...
    "External relay search is not available for this link type": "Externe Relay-Suche ist für diesen Linktyp nicht verfügbar.",
    "Searched external relays not found": "{{count}} externe Relays durchsucht; die Note wurde nicht gefunden.",
    ...
    "Session relays preset working hint": "Preset-Relays (App-Standard), die die Session-Fehlerschwelle (2 Fehler) noch nicht erreicht haben.",
    ...
    "eventArchive.defaultsElectron": "Desktop app defaults: ~{{lru}} in-memory events, ~{{mb}} MB / {{ev}} archived events.",
    ...
    "Hide content from untrusted users": "Inhalte von nicht vertrauenswürdigen Benutzern ausblenden",
    "Only show content from your followed users and the users they follow": "Nur Inhalte von Benutzern anzeigen, denen du folgst und die sie folgen",
    ...
    Balance: "Guthaben",
    characters: "Zeichen",
    translateApiKeyDescription: "Du kannst diesen API-Schlüssel überall dort verwenden, wo LibreTranslate unterstützt wird. Die Service-URL ist {{serviceUrl}}",
    "Top up": "Aufladen",
    ...
    "Are you sure you want to reset your API key? This action cannot be undone.": "Bist du sicher, dass du deinen API-Schlüssel zurücksetzen möchtest? Diese Aktion kann nicht rückgängig gemacht werden.",
    Warning: "Warnung",
    ...
    notificationsViewAsAccountAria: "Gespeichertes Konto wechseln. Benachrichtigungen, Antworten, Zaps, Reaktionen und Boosts nutzen dieses Konto.",
    ...
    "Currently hiding {type} from untrusted users.": "Derzeit werden {{type}} von nicht vertrauenswürdigen Benutzern ausgeblendet.",
    ...
    "Click continue to hide {type} from untrusted users.": "Klicke auf Weiter, um {{type}} von nicht vertrauenswürdigen Benutzern auszublenden.",
    "Trusted users include people you follow and people they follow.": "Vertrauenswürdige Benutzer sind Personen, denen du folgst, und Personen, denen sie folgen.",
    Continue: "Weiter",
    ...
    "You need to add at least one blossom server in order to upload media files.": "Du musst mindestens einen Blossom-Server hinzufügen, um Mediendateien hochladen zu können.",
    ...
    "Unlike regular notes, polls are not widely supported and may not display on other clients.": "Im Gegensatz zu regulären Notizen werden Umfragen nicht weit verbreitet unterstützt und werden möglicherweise nicht in anderen Clients angezeigt.",
    ...
    "After changing emojis, you may need to refresh the page": "Nach dem Ändern von Emojis müssen Sie möglicherweise die Seite aktualisieren",
    "Too many read relays": "Zu viele Lese-Relays",
    "Too many write relays": "Zu viele Schreib-Relays",
    "You have {{count}} read relays. Most clients only use 2-4 relays, setting more is unnecessary.": "Sie haben {{count}} Lese-Relays. Die meisten Clients verwenden nur 2-4 Relays, mehr einzustellen ist unnötig.",
    "You have {{count}} write relays. Most clients only use 2-4 relays, setting more is unnecessary.": "Sie haben {{count}} Schreib-Relays. Die meisten Clients verwenden nur 2-4 Relays, mehr einzustellen ist unnötig.",
    ...
    "Release notes use the editor below (optional).": "Release-Notizen stehen im Editor unten (optional).",
    ...
    "Composer JSON tab hint": "Entwurf als JSON bearbeiten (nur `kind`, `content`, `tags`). `kind` muss zur gewählten Notizart passen. Weitere Felder werden beim Veröffentlichen gesetzt.",
    "Composer JSON apply": "JSON anwenden",
    composerJsonKindMismatch: "JSON-Kind {{got}} passt nicht zum Editor (erwartet {{expected}}). Notizart ändern oder `kind` im JSON anpassen.",
    ...
    "No recent posts from this user in the current fetch": "Keine aktuellen Beiträge von diesem Nutzer in dieser Abfrage",
    "Loading trending notes from your relays...": "Trendende Notizen werden geladen …",
    "Trending on Nostr": "Trending auf Nostr",
    "Home trending slice notice": "Dieser Feed enthält eine Trending-Spur (nostrarchives). Notizen, die von diesem Relay kamen, zeigen unter der Karte „Trending auf Nostr“.",
    Sort: "Sortierung",
    newest: "neueste",
    oldest: "älteste",
    ...
    Disconnect: "Trennen",
    "Set up your wallet to send and receive sats!": "Richte deine Wallet ein, um Sats zu senden und zu empfangen!",
    "Set up": "Einrichten",
    ...
    "COUNT spell relay errors hint": "Mindestens ein Relay ist fehlgeschlagen oder hat einen Fehler gemeldet. Du kannst die Relay-Liste im Zauber anpassen und erneut speichern.",
    "COUNT spell total distinct explanation": "Verschiedene passende Event-IDs über alle erfolgreich antwortenden Relays (Duplikate zwischen Relays entfernt). Jedes Relay liefert höchstens so viele wie im Limit steht.",
    "Leave empty to use your write relays.": "Leer lassen, um deine Schreib-Relays (Outbox) zu verwenden.",
    "COUNT spell result explanation": "Verschiedene Events, die zum Filter passen (von den Relays des Zaubers und Standard-Schreib-Relays zusammengeführt, Duplikate entfernt). Relays liefern höchstens so viele wie im Limit steht.",
    "COUNT spell may be capped by limit": "Die Zahl kann deinem Limit entsprechen — es könnte noch mehr passende Events geben.",
    "Spell count failed. Check relays or try again.": "Zählung fehlgeschlagen. Relays prüfen oder erneut versuchen.",
    ...
    "Accessed on": "Accessed on",
    "Add RSS feed URLs to subscribe to. If no feeds are configured, the default feed will be used.": "Add RSS feed URLs to subscribe to. If no feeds are configured, the default feed will be used.",
    ...
    "Add recipients using nostr: mentions (e.g., nostr:npub1...) or the recipient selector above": "Add recipients using nostr: mentions (e.g., nostr:npub1...) or the recipient selector above",
    ...
    "Failed to create thread. Please try a different relay.": "Failed to create thread. Please try a different relay.",
    ...
    "High PoW": "High PoW",
    "Higher values make your thread harder to mine but more unique.": "Higher values make your thread harder to mine but more unique.",
    Highlight: "Highlight",
    ...
    "No feeds configured. Default feed will be used.": "No feeds configured. Default feed will be used.",
    ...
    "No relays available. Please configure relays in settings.": "No relays available. Please configure relays in settings.",
    ...
    "Article URLs subtitle": "One card per link: URLs from Nostr relays (you and people you follow) plus any RSS hit. No RSS row yet → web preview card.",
    "Article URLs Nostr manual subtitle": "Artikel-URLs ohne Einträge aus abonnierten Feeds — von Nostr-Relays oder von dir hinzugefügt. Sobald ein Feed Einträge liefert, erscheint die Karte unter RSS.",
    "RSS feed column title": "RSS & verknüpfte Artikel",
    "RSS feed column subtitle": "Feed-Einträge und Artikelkarten mit mindestens einem Eintrag aus deinen abonnierten RSS-Feeds.",
    ...
    "Hide local, media & feed URLs from URL cards": "Hide local, media, feed, document & XML links from the feed",
    ...
    "Pinned notes hint": "Pinned notes: use the note menu (⋯) on a note and choose pin to profile. Pins appear on your profile.",
    "Bookmarks list section title": "Bookmarks list",
    "Bookmarks list section subtitle": "Events referenced by `e` / `a` tags on your kind 10003 bookmark list (newest first).",
    ...
    "Pinned notes list section subtitle": "Events referenced by `e` / `a` tags on your kind 10001 pin list (same order as on your profile).",
    ...
    "Relay requires authentication for write access. Please try a different relay or contact the relay operator.": "Relay requires authentication for write access. Please try a different relay or contact the relay operator.",
    ...
    "Required: start time or start date. Optional: title, end, location, summary, topics, image.": "Required: start time or start date. Optional: title, end, location, summary, topics, image.",
    ...
    "Required: start time. Join link defaults to HiveTalk. Optional: title, end, summary, topics, image.": "Required: start time. Join link defaults to HiveTalk. Optional: title, end, summary, topics, image.",
    ...
    "Share your thoughts, ask questions, or start a discussion...": "Share your thoughts, ask questions, or start a discussion...",
    ...
    Since: "Seit",
    Small: "Small",
    "Some relays have temporarily disabled writes.": "Some relays have temporarily disabled writes.",
    Source: "Source",
    ...
    "Threads are organized by topics. Choose a topic that best fits your discussion.": "Threads are organized by topics. Choose a topic that best fits your discussion.",
    ...
    "Unique identifier for this article (required)": "Unique identifier for this article (required)",
    ...
    "Your account is blocked from posting to this relay.": "Your account is blocked from posting to this relay.",
    Zap: "Zap",
    ...
    "sent you a public message (along with {{count}} others)": "sent you a public message (along with {{count}} others)",
    sig: "sig",
    ...
    "Save or discard your changes before refreshing from relays": "Save or discard your changes before refreshing from relays",
