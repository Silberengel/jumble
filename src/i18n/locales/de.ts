export default {
  translation: {
    ...
    'Relay membership required (NIP-42)':
      ' PH0   erfordert eine Mitgliedschaft oder einen Zugriff, den Sie nicht haben —   PH1  ',
    ...
    'Please log in to view notifications.':
      'Bitte melden Sie sich an, um Benachrichtigungen anzuzeigen.',
    ...
    'Payment address – copy to use in your wallet or app':
      'Zahlungsadresse – Kopie zur Verwendung in Ihrer Wallet oder App',
    'Open in your wallet app or copy the address below.':
      'Öffnen Sie in Ihrer Wallet-App oder kopieren Sie die unten stehende Adresse.',
    ...
    'Create a BOLT11 invoice from this Lightning address, then pay in your connected wallet or another app.':
      'Erstellen Sie eine BOLT11-Rechnung aus dieser Lightning-Adresse und zahlen Sie dann in Ihrer angeschlossenen Brieftasche oder einer anderen App.',
    ...
    'This address does not support payment descriptions.':
      'Diese Adresse unterstützt keine Zahlungsbeschreibungen.',
    'Could not read this Lightning address (network or browser block). Descriptions need LNURL-pay support on the recipient side.':
      'Konnte diese Lightning-Adresse (Netzwerk- oder Browserblock) nicht lesen. Beschreibungen benötigen LNURL-Pay-Unterstützung auf der Empfängerseite.',
    ...
    'Profile reports dialog description':
      'Berichte, die von diesem profil erhalten und eingereicht wurden.',
    ...
    userStatusNip38Hint:
      'NIP-38 Live-Status (Art 30315). Neben deinem namen in posts und deinem profil.',
    ...
    'Post payment prompt label':
      'Wenn Sie eine Zahlung erfolgreich abgeschlossen haben, können Sie:',
    ...
    'Superchat request prompt description':
      'Veröffentlichung einer Zahlungsbenachrichtigung (Art 9740). Der empfänger kann bestätigen, dass er ihre zahlung erhalten hat, so dass diese nachricht als superchat erscheinen kann.',
    ...
    'Superchat estimated amount hint':
      'Fakultativ Auf der Veranstaltung als Millisats (sats × 1000) gespeichert.',
    ...
    'Profile search failed':
      'Profilsuche konnte nicht abgeschlossen werden. Überprüfen Sie Ihre Verbindung oder versuchen Sie es erneut.',
    Replies: 'Antworten',
    ...
    'Search your library and tap a GIF to insert.':
      'Durchsuchen Sie Ihre Bibliothek und tippen Sie auf ein GIF zum Einfügen.',
    'Paste a GIF URL, upload your own file, or search GifBuddy.':
      'Fügen Sie eine GIF-URL ein, laden Sie Ihre eigene Datei hoch oder suchen Sie nach GifBuddy.',
    'Opens GifBuddy in a new tab. Copy a GIF URL there, then paste it below.':
      'Öffnet GifBuddy in einem neuen Tab. Kopieren Sie dort eine GIF-URL und fügen Sie sie unten ein.',
    ...
    'No meme templates found. Try searching or open Meme Amigo. The grid only lists kind 1063 (NIP-94) files tagged memeamigo (not random photos from notes).':
      'Keine Meme-Vorlagen gefunden. Suchen oder öffnen Sie Meme Amigo. Das Raster listet nur Dateien der Art 1063 (NIP-94) auf, die mit Memeamigo gekennzeichnet sind (keine zufälligen Fotos aus Notizen).',
    'Failed to publish meme template for the picker':
      'Keine Meme-Vorlage für den Picker veröffentlicht',
    ...
    hiddenNetworkRelaysIntro:
      'Tor (.onion) und I2P (.i2p) Relay-URLs benötigen einen lokalen SOCKS-Proxy. Imwald leitet sie durch eine loopback-brücke, wenn sie npm run dev lokal ausführen.',
    hiddenNetworkRelaysWebLimit:
      'Die öffentliche Website kann Hidden-Network-Relays nicht direkt erreichen. Verwenden Sie hier Clearnet-Relay-URLs oder führen Sie npm run dev lokal mit Tor/I2P aus.',
    ...
    hiddenNetworkBrowserOnlyNotice:
      'Verwenden Sie npm run dev lokal, um eine Verbindung zu .onion und .i2p Relais herzustellen.',
    hiddenNetworkStartRoutersHint:
      'Starten Sie Tor (9050 oder Tor Browser 9150) und / oder I2P (7657), und drücken Sie dann Refresh. Erste Verbindungen können bis zu einer Minute dauern, während Schaltungen aufgebaut werden.',
    hiddenNetworkReadyHint:
      'Local SOCKS ist erreichbar. Fügen Sie ws://...onion... oder ws://....i2p... Relay-URLs zu Ihrem Postfach oder Favoriten wie jedes andere Relay hinzu.',
    hiddenNetworkEnvHint:
      'Optional: automatisch erkannte SOCKS-URLs beim Starten von Imwald überschreiben:',
    ...
    'Sign up creates a private key stored in this browser. Back it up anytime under Settings → Cache & offline storage.':
      'Die Anmeldung erstellt einen privaten Schlüssel, der in diesem Browser gespeichert ist. Sichern Sie es jederzeit unter Einstellungen → Cache & Offline-Speicher.',
    ...
    'Your private key is stored in this browser. Clearing cache does not remove your account, but losing this browser profile does. Back up your key somewhere safe.':
      'Ihr privater Schlüssel wird in diesem Browser gespeichert. Durch das Löschen des Cache wird Ihr Konto nicht entfernt, der Verlust dieses Browserprofils jedoch. Sichern Sie Ihren Schlüssel irgendwo sicher.',
    'This account uses an encrypted key (ncryptsec). Use Show key and your encryption password to reveal the original nsec for backup.':
      'Dieses Konto verwendet einen verschlüsselten Schlüssel (ncryptsec). Verwenden Sie den Schlüssel anzeigen und Ihr Verschlüsselungspasswort, um die ursprüngliche nsec für das Backup anzuzeigen.',
    'Could not decrypt — check your password and try again.':
      'Konnte nicht entschlüsseln - überprüfen Sie Ihr Passwort und versuchen Sie es erneut.',
    'Show key': 'Showkey',
    'Hide key': 'Schlüssel ausblenden',
    'Do not share this with anyone. Anyone with this key can control your account.':
      'Teilen Sie dies mit niemandem. Jeder mit diesem Schlüssel kann Ihr Konto kontrollieren.',
    ...
    'Your account was just created. Copy your nsec (or ncryptsec) below and store it somewhere safe — password manager, encrypted file, or paper offline. Anyone with this key controls your account.':
      'Dein Account wurde gerade erstellt. Kopieren Sie Ihre nsec (oder ncryptsec) unten und speichern Sie sie an einem sicheren Ort - Passwort-Manager, verschlüsselte Datei oder Papier offline. Jeder mit diesem Schlüssel kontrolliert Ihr Konto.',
    'After backing up, you can remove the key from this browser and sign in with a browser extension or bunker instead.':
      'Nach dem Sichern können Sie den Schlüssel aus diesem Browser entfernen und sich stattdessen mit einer Browsererweiterung oder einem Bunker anmelden.',
    ...
    'The private key will be deleted from this browser only. Make sure you have copied it first. This account will become read-only here until you log in again with an extension, bunker, or private key.':
      'Der private Schlüssel wird nur aus diesem Browser gelöscht. Stellen Sie sicher, dass Sie es zuerst kopiert haben. Dieses Konto wird hier schreibgeschützt, bis Sie sich mit einer Erweiterung, einem Bunker oder einem privaten Schlüssel erneut anmelden.',
    'Local private key removed. This account is read-only here until you log in with an extension, bunker, or private key again.':
      'Lokaler privater Schlüssel entfernt. Dieses Konto wird hier nur gelesen, bis Sie sich erneut mit einer Erweiterung, einem Bunker oder einem privaten Schlüssel anmelden.',
    ...
    'Unsupported event preview':
      'Es gibt noch keine dedizierte Karte für diesen Veranstaltungstyp. Hier ist eine lesbare Vorschau.',
    ...
    'Orphaned imeta media notice':
      'Dieses Medium wurde in den Tags gefunden, ist aber entweder dupliziert oder unterscheidet sich von dem im Inhalt. Bitte kontaktieren Sie den Entwickler des Clients, der dieses Ereignis erstellt hat, um diesen Fehler zu beheben.',
    ...
    'This wallet did not report a Lightning address.':
      'Diese Brieftasche hat keine Lightning-Adresse gemeldet.',
    ...
    'When off, your zap may still succeed but a public receipt may not be published to relays':
      'Wenn Sie ausgeschaltet sind, ist Ihr Zap möglicherweise immer noch erfolgreich, aber eine öffentliche Quittung wird möglicherweise nicht an Relais veröffentlicht',
    ...
    'The note was not found on your relays or default relays.':
      'Die Notiz wurde nicht auf Ihren Relais oder Standardrelais gefunden.',
    ...
    'Your relays first, then those your network favors and reviews.':
      'Ihre Relais zuerst, dann diejenigen, die Ihr Netzwerk bevorzugt und überprüft.',
    ...
    refreshCacheButtonExplainer:
      'Refresh Cache führt einen IndexedDB-Upgrade-Check aus, ruft Ihre Relay-Listen und profilbezogenen Ereignisse aus dem Netzwerk erneut ab (die gleiche Arbeit wie die automatische Startsynchronisierung), synchronisiert Art-5-Löschungen in Grabsteine und entfernt gelöschte Elemente aus dem lokalen Cache und aktualisiert dann die unten aufgeführten Speicher.',
    'eventArchive.sectionTitle': 'Notizen & Feed-Archiv',
    'eventArchive.sectionBlurb':
      'Behält Notizen, Reaktionen und Zeitleistenreihenfolge auf der Festplatte, so dass Feeds offline oder auf langsamen Links geladen werden können. Ersetzbare Daten (Profile, Relaislisten, Publikationen) bleiben in den bestehenden Geschäften erhalten – dieses Archiv füllt nur Lücken für „Firehose-Ereignisse.',
    'eventArchive.defaultsMobile':
      'Dieses Geräteprofil verwendet kleine Standardwerte: über   PH0   Ereignisse im Speicher, ~  PH1   MB /   PH2   archivierte Ereignisse (Reaktionen / Zaps fallen zuerst).',
    'eventArchive.defaultsDesktopWeb':
      'Desktop-Browser-Standards: ~  PH0   In-Memory-Ereignisse, ~  PH1   MB /   PH2   archivierte Ereignisse.',
    'eventArchive.defaultsLightArchive':
      'Lichtarchiv (Cache-Relay auf): ~  PH0   In-Memory Events, ~  PH1   MB /   PH2   Micro-Archiv nur für geöffnete Notizen und Lesezeichen.',
    ...
    'eventArchive.effectiveSummary':
      'Derzeit: ~  PH0   MB budget,   PH1   events,   PH2   session LRU.',
    ...
    'Bookmark not in list':
      'Dieses Lesezeichen ist nicht in Ihrer Liste (bereits entfernt oder nicht synchronisiert).',
    'Pin not in list':
      'Dieser Pin ist nicht in Ihrer Liste (bereits entfernt oder nicht synchronisiert).',
    'Entry not in list':
      'Dieser Eintrag ist nicht in Ihrer Liste (bereits entfernt oder nicht synchronisiert).',
    'Removed from notification thread follow list':
      'Entfernt aus Thread Benachrichtigung Follow List',
    ...
    'accountSwitch.anonHint':
      'Jeder Beitrag, jede Antwort, Reaktion oder Auth verwendet einen neuen Schlüssel. Standardmäßig nur Lese-/Schreibrelais.',
    'accountSwitch.anonHintShort': 'Frischer Schlüssel für jede Aktion · Standardrelais',
    'accountSwitch.anonCannotDelete':
      'Anonyme Sitzungen können keine Notizen löschen (jede Aktion verwendet einen neuen Schlüssel).',
    'accountSwitch.anonIdentityDisabled':
      'Wechseln Sie zu einem angemeldeten Konto für Profil, Follow, Stummschaltung und andere Identitätsmerkmale.',
    Continue: 'Weiter',
    ...
    heatMapRescanHint:
      'Nur Sitzungs-Cache und lokales Archiv anzeigen. Tippen Sie auf Rescan, um einen neuen Snapshot von Relais abzurufen.',
    ...
    'Profile interactions map description':
      'Profile, die nach direkter Interaktion eingestuft werden, zählen zu diesem Profil. Datenfarben aus dem lokalen Cache zuerst, dann aktualisiert von Relais.',
    'Profile interactions map empty':
      'Noch keine Profilinteraktionen gefunden. Durchsuchen Sie dieses Profil oder rescannen Sie nach der Synchronisierung.',
    ...
    'Successfully republish to all available relays':
      'Erfolgreiches Republishing für alle verfügbaren Relais',
    'Failed to republish to all available relays: {{error}}':
      'Nicht in allen verfügbaren Relais veröffentlicht:   PH0  ',
    'Successfully republish to all active relays':
      'Erfolgreiches Republishing für alle aktiven Relais',
    'Failed to republish to all active relays: {{error}}':
      'Nicht in allen aktiven Relais veröffentlicht:   PH0  ',
    ...
    'Only {{count}} relay(s) accepted the event; at least 5 required for "all active relays".':
      'Nur   PH0   Relais haben das Ereignis akzeptiert; mindestens 5 sind für "alle aktiven Relais" erforderlich.',
    ...
    'You have {{count}} read relays. Most clients only use up to {{limit}} relays, setting more is unnecessary.':
      'Sie haben   PH0  Relays gelesen. Die meisten Clients verwenden nur bis zu   PH1  -Relays, die Einstellung von mehr ist unnötig.',
    'You have {{count}} write relays. Most clients only use up to {{limit}} relays, setting more is unnecessary.':
      'Sie haben   PH0   Schreibrelais. Die meisten Clients verwenden nur bis zu   PH1  -Relays, die Einstellung von mehr ist unnötig.',
    ...
    'Advanced lab json preview hint':
      'Read-only-Publish-Entwurf: `kind`, `content`, `created at` und `tags` (einschließlich `imeta` von URLs im Body und dem Imwald `client`-Tag, wenn in Post-Optionen aktiviert). `pubkey`, `id` und `sig` werden auf publish gesetzt.',
    ...
    'Translate note': 'Übersetzende Anmerkung',
    ...
    'Read-aloud Piper English voice fallback detail':
      'Piper hat kein Sprachmodell für   PH0  . Diese Sitzung verwendet stattdessen die englische Piper-Stimme; Aussprache kann nicht mit dem geschriebenen Text übereinstimmen.',
    'Read-aloud Piper related voice fallback title': 'Approximate Piper Stimme',
    'Read-aloud Piper related voice fallback detail':
      'Piper hat kein Modell für   PH0  . Diese Sitzung verwendet die   PH1   Piper-Stimme als Approximation; die Aussprache stimmt möglicherweise nicht mit dem geschriebenen Text überein.',
    ...
    advancedLabTagsHint:
      'Alle Tags außer dem Client-Tag. Ein Wert pro Zeile für Multi-Value-Tags. Änderungen werden automatisch gespeichert.',
    ...
    'Library search placeholder':
      'Publikationen nach Titel, Autor, Quelle, Tag oder Abschnitt suchen…',
    ...
    'Library relay search timed out':
      'Relay-Suche abgelaufen. Treffer aus dem lokalen Bibliotheks-Cache werden angezeigt, sofern vorhanden.',
    ...
    'Library status line':
      '{{shown}} angezeigt · {{topLevel}} Top-Level · {{total}} Indizes geladen',
    ...
    'Asciidoc parse warning body':
      'Einige AsciiDoc in diesem Abschnitt sind ungültig oder verwenden eine nicht unterstützte Syntax. Der unten stehende Text wird nach Möglichkeit as-is angezeigt.',
    ...
    'Not an NWC connection (no relay URL in config).':
      'Keine NWC-Verbindung (keine Relay-URL in config).',
    ...
    'Add the source (where this text is from)':
      'Fügen Sie die Quelle hinzu (woher dieser Text stammt)',
    ...
    'Are you sure you want to clear all cached data? This will delete all stored events and settings from your browser.':
      'Sind Sie sicher, dass Sie alle zwischengespeicherten Daten löschen möchten? Dadurch werden alle gespeicherten Ereignisse und Einstellungen in Ihrem Browser gelöscht.',
    'Are you sure you want to delete all items from this store?':
      'Sind Sie sicher, dass Sie alle Artikel aus diesem Shop löschen möchten?',
    'Are you sure you want to unmute this user? This will restore the follow button.':
      'Sind Sie sicher, dass Sie diesen Benutzer ausschalten möchten? Dadurch wird der Follow-Button wiederhergestellt.',
    "Are you sure you want to unregister the service worker? This will clear this app's service worker caches and you will need to reload the page.":
      'Sind Sie sicher, dass Sie den Servicemitarbeiter abmelden möchten? Dadurch werden die Service Worker Caches dieser App gelöscht und Sie müssen die Seite neu laden.',
    ...
    'No cached events match your search.':
      'Keine zwischengespeicherten Ereignisse passen zu Ihrer Suche.',
    ...
    'Browse cache root description':
      'Zeigen Sie IndexedDB-Stores an oder suchen Sie alle zwischengespeicherten Nostr-ähnlichen Ereignisse (Inhalte, Tags, ID, Pubkey, Art) in allen Geschäften.',
    ...
    'Broadcasting to outbox HTTP and cache relays…':
      'Broadcasting an Outbox, HTTP und Cache-Relays..',
    ...
    'No mailbox cache or HTTP write relays configured':
      'Keine Mailbox, Cache oder HTTP-Schreibrelais konfiguriert',
    'Publish this event to your NIP-65 outbox, HTTP write relays, and cache relays':
      'Veröffentlichen Sie dieses Ereignis in Ihrer NIP-65-Outbox, schreiben Sie HTTP-Relays und Cache-Relays',
    'C-Tag': 'C-Tag',
    ...
    'Cache relays are used to store and retrieve events locally. These relays are merged with your inbox and outbox relays.':
      'Cache-Relays werden verwendet, um Ereignisse lokal zu speichern und abzurufen. Diese Relais werden mit Ihren Inbox- und Outbox-Relais zusammengeführt.',
    'Use cache relays on this device': 'Cache-Relays auf diesem Gerät nutzen',
    'Use cache relays on this device hint':
      'Auf Computern ohne lokalen Cache-Relay (z. B. ws://localhost:4869) ausschalten. Die Relay-Liste bleibt gespeichert; nur dieses Gerät verbindet sich nicht mehr.',
    'Use cache relays light archive hint':
      'Bei mindestens einer Cache-Relay-URL verwendet Jumble ein Lichtarchiv: Notizen bleiben im Sitzungsspeicher und auf Ihrem Relais anstelle einer großen Browserdatenbank.',
    ...
    'cacheOverview.advancedStoresHint':
      'Erweitert: Öffnen Sie unten einen Shop für rohe IndexedDB-Zeilen, suchen und senden.',
    'Cache relays must be local network URLs only (e.g., ws://localhost:4869 or ws://127.0.0.1:4869)':
      'Cache-Relays müssen nur lokale Netzwerk-URLs sein (z. B. ws://localhost:4869 oder ws://127.0.0.1:4869)',
    ...
    'Clean up duplicate replaceable events? This will keep only the newest version of each event.':
      'Bereinigen Sie doppelt austauschbare Ereignisse? Dadurch bleibt nur die neueste Version jedes Events erhalten.',
    'Cleaned up {{deleted}} duplicate entries, kept {{kept}}':
      'Bereinigt   PH0   doppelte Einträge, gehalten   PH1  ',
    'Cleaned up {{deleted}} duplicate entries, kept {{kept}} (total items after cleanup: {{total}})':
      'Bereinigt   PH0   doppelte Einträge, gehalten   PH1   (Gesamtpositionen nach Bereinigung:   PH2  )',
    ...
    'Click update to get the latest features and improvements':
      'Klicken Sie auf Update, um die neuesten Funktionen und Verbesserungen zu erhalten',
    Close: 'Schließen',
    'Comma or space-separated topics (will be added as t-tags)':
      'Komma- oder raumgetrennte Themen (werden als T-Tags hinzugefügt)',
    Command: 'Befehl',
    ...
    'Enter a Nostr event identifier (nevent, naddr, note, or hex ID) OR a web URL (https://). Not both.':
      'Geben Sie eine Nostr-Ereigniskennung (Nevent, naddr, Note oder hex ID) ODER eine Web-URL (https://) ein. Nicht beides.',
    'Enter a descriptive title for your thread':
      'Geben Sie einen beschreibenden Titel für Ihren Thread ein',
    ...
    'Failed to add relay. Please try again.':
      'Es wurde kein Relais hinzugefügt. Bitte versuchen Sie es noch einmal.',
    'Failed to add relays': 'Relais nicht hinzugefügt',
    'Failed to block relay. Please try again.':
      'Das Relais konnte nicht blockiert werden. Bitte versuchen Sie es noch einmal.',
    ...
    'Failed to create relay set. Please try again.':
      'Es wurde kein Relais-Set erstellt. Bitte versuchen Sie es noch einmal.',
    ...
    'Insert URL into your post and publish to Nostr GIF library (NIP-94).':
      'Fügen Sie URL in Ihren Beitrag ein und veröffentlichen Sie sie in der Nostr GIF-Bibliothek (NIP-94).',
    'Insert URL into your post and publish kind 1063 (NIP-94) with hashtag memeamigo for discoverability.':
      'Fügen Sie URL in Ihren Beitrag ein und veröffentlichen Sie die Art 1063 (NIP-94) mit dem Hashtag memeamigo zur Auffindbarkeit.',
    ...
    'Create citation dialog hint':
      'Veröffentlichen Sie ein NIP-32-Zitat in Ihren privaten Relais und fügen Sie dann eine Referenz in diesen Beitrag ein.',
    ...
    'Invalid Lightning Address. Please enter a valid Lightning Address or LNURL.':
      'Invalid Lightning Adresse. Bitte geben Sie eine gültige Lightning Address oder LNURL ein.',
    'Invalid URL': 'Ungültige URL',
    'Invalid relay URL': 'URL für ungültiges Relay',
    'Invalid source. Please enter a note ID, nevent, naddr, hex ID, or URL.':
      'Ungültige Quelle. Bitte geben Sie eine Notiz-ID, nevent, naddr, hex ID oder URL ein.',
    ...
    'Leave empty for HiveTalk, or paste Zoom / Teams / other link':
      'Lassen Sie für HiveTalk leer oder fügen Sie Zoom / Teams / anderen Link ein',
    ...
    'Content warning hint':
      'Fügt ein NIP-36 Content-Warning-Tag hinzu, so dass die Leser sich anmelden müssen, um diese Notiz anzuzeigen.',
    ...
    'Post editor content warning summary':
      'Inhaltswarnung hinzugefügt:   PH0  . Öffnen Erweitert zum Ändern.',
    ...
    'No service workers or caches found for this app':
      'Keine Servicemitarbeiter oder Caches für diese App gefunden',
    ...
    'Opens in a new tab. Copy an image URL there, then paste below. If this picker closed, click “Insert meme” again to paste.':
      'Öffnet sich in einem neuen Tab. Kopieren Sie dort eine Bild-URL und fügen Sie unten ein. Wenn dieser picker geschlossen ist, klicken sie erneut auf "meme einfügen", um einzufügen.',
    Optional: 'Fakultativ',
    ...
    'Optionally, add the full quote/context to show your highlight within it':
      'Optional fügen Sie das vollständige Zitat / Kontext hinzu, um Ihr Highlight darin anzuzeigen',
    PM: 'PM',
    ...
    'Paste the entire original passage that contains your highlight':
      'Fügen Sie die gesamte Originalpassage ein, die Ihr Highlight enthält',
    Photo: 'Foto',
    ...
    'Publish kind 1063 (NIP-94) for this GIF and insert the URL into your post':
      'Veröffentlichen Sie die Art 1063 (NIP-94) für dieses GIF und fügen Sie die URL in Ihren Beitrag ein',
    ...
    'User emoji list intro':
      'NIP-30: Inline benutzerdefinierte Emoji („Emoji-Tags) und Verweise auf Ihre 30030 Pakete („a-Tags). Veröffentlichen Sie, wenn Sie mit der Bearbeitung fertig sind.',
    'User emoji list saved': 'Emoji-Liste veröffentlicht',
    'User emoji inline section': 'Inline-Emoji',
    'User emoji inline empty':
      'Noch kein Inline-Emoji. Fügen Sie unten einen Shortcode und eine Bild-URL hinzu.',
    ...
    'User emoji sets hint':
      'Fügen Sie eine Koordinate in der Form 30030:<64-hex pubkey>:<d tag> hinzu, normalerweise eine Ihrer eigenen Emoji-Sets auf der Emoji-Sets-Seite.',
    ...
    'Emoji sets settings intro':
      'NIP-30 Emoji-Packs (Art 30030): Jedes Set hat einen `d`-Tag und `emoji`-Einträge (Shortcode + Bild-URL). Veröffentlichen aus dem Editor Dialog.',
    ...
    'Emoji set d tag hint':
      'Stabile Kennung für diese Packung. Es kann nicht nach der ersten Veröffentlichung geändert werden.',
    ...
    'Delete emoji set confirm':
      'Dieser sendet eine Löschaufforderung (Art 5). Relais, die es akzeptieren, lassen das Set fallen; andere zeigen möglicherweise noch eine zwischengespeicherte Kopie.',
    'Interests list section subtitle':
      'Themen, denen Sie für Hashtag-Feeds und den Interessenzauber folgen. Gespeichert auf Nostr als Art 10015 (`t`-Tags).',
    'Interest topic placeholder': 'thema oder #hashtag',
    'Interest list add topic': 'Thema hinzufügen',
    'Interest topic invalid':
      'Geben Sie ein gültiges Thema ein (Buchstaben, Zahlen, Bindestriche, Unterstriche).',
    'No interest topics in list':
      'Noch keine abonnierten Themen. Fügen Sie eine oben oder abonnieren Sie von einer Hashtag-Seite.',
    "username's interest topics": " PH0  's Interessenthemen",
    'Remove from interest list': 'Von der Interessenliste entfernen',
    'Personal lists interests spell hint':
      'Für einen kombinierten Feed aller abonnierten Themen verwenden Sie die',
    'Interests spell': 'Zinsen Zauber',
    'Personal lists bookmarks spell hint':
      'Für einen Notizfeed aus NIP-51-Lesezeichen verwenden Sie die',
    ...
    'No NIP-51 bookmarks or web bookmarks yet.':
      'Keine NIP-51 Lesezeichen oder Web-Lesezeichen noch.',
    'Web bookmarks': 'Web-Lesezeichen',
    'Web bookmark': 'Web Bookmark',
    'Web bookmarks NIP intro':
      'Web-Lesezeichen werden als Art 39701-Ereignisse gespeichert, nicht in Ihrer NIP-51-Lesezeichenliste.',
    'Log in to save web bookmarks':
      'Melden Sie sich an, um Web-Lesezeichen für diese Seite zu speichern (NIP-B0, Art 39701).',
    'Remove web bookmark': 'Web Bookmark entfernen',
    'No web bookmark for this URL yet':
      'Sie haben noch kein Web-Bookmark für diese URL gespeichert.',
    ...
    'Save a link with optional title and note (kind 39701)':
      'Speichern Sie einen Link mit optionalem Titel und Notiz (Art 39701)',
    'Sign in to publish web bookmark':
      'Bitte melden Sie sich mit einem Signaturschlüssel an, um Web-Lesezeichen zu speichern.',
    ...
    'Clean list confirm':
      'Dadurch wird ein frischer, leerer Ersatz für diese Liste veröffentlicht (alle Einträge entfernt). Dies kann nicht rückgängig gemacht werden.',
    'Clean follows list confirm with backup':
      'Bevor Sie Ihre Follower (Art 3) bereinigen, wird der aktuelle Listen-Snapshot für folgende History-Relays veröffentlicht. Dann wird eine frische, leere Follower-Liste veröffentlicht. Weiter so?',
    ...
    'Recommended applications for handling events of kind {{kind}}':
      'Empfohlene Anträge auf Bearbeitung von Ereignissen der Art   PH0  ',
    'Reference to the cited Nostr event in kind:pubkey:hex format':
      'Verweis auf das zitierte Nostr-Ereignis im Format kind:pubkey:hex',
    ...
    'Required: start (or start date), invitees. Optional: title, end, location, summary, topics, image.':
      'Erforderlich: Start (oder Startdatum), eingeladen. Optional: Titel, Ende, Ort, Zusammenfassung, Themen, Bild.',
    'Required: start time, invitees. Join link defaults to HiveTalk. Optional: title, end, summary, topics, image.':
      'Erforderlich: Startzeit, eingeladene Personen. Verbinden Sie Link Defaults zu HiveTalk. Optional: Titel, Ende, Zusammenfassung, Themen, Bild.',
    ...
    'General search merged intro':
      'Durchsucht Ihren lokalen Cache (bis zu   PH0  s), fragt dann Ihre Relais ab und sucht Index-Relays (kein NIP-50). Jedes Relais gibt aktuelle Notizen zurück; Übereinstimmungen werden nach Titel, Zusammenfassung, Beschreibung und Inhalt gefiltert. Bis zu   PH1   Relais parallel (  PH2   total); die Relaiswelle stoppt nach   PH3  s oder   PH4  s nach den ersten Treffern.',
    'Full-text search source relays': 'Relais',
    'Notes search local intro':
      'Durchsucht Ihren lokalen Cache und Archiv – Sitzungsspeicher, Publikations-Cache und Ereignisarchiv auf diesem Gerät. Übereinstimmungen Titel, Zusammenfassung, Beschreibung, Kontext, Inhalt und ähnliche lesbare Felder.',
    'Full-text search empty local':
      'Keine Notizen passten zu dieser Suche in Ihrem lokalen Cache oder Archiv.',
    ...
    'Service worker caches cleared. Please reload the page.':
      'Servicearbeiter caches gelöscht. Bitte laden Sie die Seite neu.',
    'Service worker unregistered and caches cleared. Please reload the page.':
      'Servicemitarbeiter nicht registriert und Caches gelöscht. Bitte laden Sie die Seite neu.',
    'Service worker unregistered. Please reload the page.':
      'Servicemitarbeiter nicht registriert. Bitte laden Sie die Seite neu.',
    ...
    'Subject (book title) is required for reading groups':
      'Thema (Buchtitel) ist für das Lesen von Gruppen erforderlich',
    ...
    'These relays were found from your NIP-05 identifier and signer. You can add them to your relay list.':
      'Diese Relais wurden von Ihrem NIP-05-Identifikator und Unterzeichner gefunden. Sie können sie zu Ihrer Relaisliste hinzufügen.',
    'This GIF comes from kind 1063 (NIP-94 file metadata). Choosing it still publishes your own kind 1063 to your write relays (and fast write relays as fallback) so your relays index the URL.':
      'Dieses GIF stammt von Art 1063 (NIP-94-Datei-Metadaten). Wenn Sie es auswählen, wird immer noch Ihre eigene Art 1063 für Ihre Schreibrelais (und schnelle Schreibrelais als Fallback) veröffentlicht, sodass Ihre Relais die URL indexieren.',
    'This GIF was found in a kind 1 note. Notes are not NIP-94 GIF index entries; publish kind 1063 yourself if you want it discoverable as file metadata.':
      'Dieses GIF wurde in einer Art 1 Note gefunden. Notizen sind keine NIP-94 GIF-Indexeinträge; veröffentlichen Sie die Art 1063 selbst, wenn Sie sie als Dateimetadaten entdecken möchten.',
    'This GIF was found in a kind 1111 comment. Comments are not NIP-94 GIF index entries; publish kind 1063 yourself if you want it discoverable as file metadata.':
      'Dieses GIF wurde in einem Kommentar der Art 1111 gefunden. Kommentare sind keine NIP-94 GIF-Indexeinträge; veröffentlichen Sie die Art 1063 selbst, wenn Sie sie als Dateimetadaten entdecken möchten.',
    'This GIF was found in a Nostr event of kind {{kind}}.':
      'Dieses GIF wurde in einem Nostr-Ereignis der Art   PH0   gefunden.',
    'This file could be either audio or video. Please select the correct type:':
      'Diese Datei kann entweder Audio oder Video sein. Bitte wählen Sie den richtigen Typ aus:',
    'This store does not contain replaceable events':
      'Dieser Shop enthält keine ersetzbaren Ereignisse',
    'This will add additional tags for author and subject to help organize reading group discussions.':
      'Dies fügt zusätzliche Tags für Autor und Thema hinzu, um Lesegruppendiskussionen zu organisieren.',
    ...
    'Use image/audio/video note kind for the media URL in the editor':
      'Verwenden Sie Bild / Audio / Video Note Art für die Medien-URL im Editor',
    'Already publishing as a media note': 'Bereits als Mediennote publizieren',
    'No media URL in note — upload or paste a link first':
      'Keine Medien-URL in der Notiz - Hochladen oder Einfügen eines Links zuerst',
    'Cannot infer media type from URL — use Note type → Media Note to upload':
      'Kann den Medientyp nicht von der URL ableiten - verwenden Sie den Notiztyp → Media Note zum Hochladen',
    'Media kind (disabled): add imeta tags, a media URL, or upload media first':
      'Medienart (deaktiviert): Fügen Sie imeta-Tags, eine Medien-URL hinzu oder laden Sie zuerst Medien hoch',
    Upvote: 'Upvote',
    ...
    'View cached items in this store.':
      'Zeigen Sie zwischengespeicherte Elemente in diesem Store an.',
    ...
    'Website where LLM was accessed (optional)':
      'Website, auf die LLM zugegriffen wurde (optional)',
    ...
    'You need to add at least one media server in order to upload media files.':
      'Sie müssen mindestens einen Medienserver hinzufügen, um Mediendateien hochzuladen.',
    Zap: 'Zap',
    ...
    'nevent1..., naddr1..., note1..., hex ID, or https://...':
      'nevent1..., naddr1..., note1..., hex ID oder https://...',
    of: 'von',
    'on note': 'auf note',
    optional: 'fakultativ',
    pubkey: 'pubkey',
    ...
    'Choose a suggested topic or type your own. It becomes a normalized tag (e.g. my-topic).':
      'Wählen Sie ein vorgeschlagenes Thema oder geben Sie Ihr eigenes ein. Es wird zu einem normalisierten Tag (z.B. my-topic).',
    ...
    profileEditorRefreshCacheHint:
      'Vollständige Kontosynchronisation von Relays (wie Einstellungen → Cache), Lösch-Tombstones, dann Profil und Zahlungsinfos.',
    ...
    'Enter a valid event kind: 0–{{maxSigned}}, or {{unsignedMin}}–{{unsignedMax}}.':
      'Geben Sie eine gültige Ereignisart ein: 0–  PH0   oder   PH1   –  PH2  .',
    'Enter a valid event kind: integer 0–{{maxSigned}}, or {{unsignedMin}}–{{unsignedMax}} (unsigned experiment).':
      'Geben Sie eine gültige Ereignisart ein: Ganzzahl 0–  PH0   oder   PH1   –  PH2   (nicht signiertes Experiment).',
    'Failed to rebroadcast entire publication: {{error}}':
      'Es ist nicht gelungen, die gesamte Publikation erneut zu übertragen:   PH0  ',
    ...
    'Kind must be an integer from 0 to {{maxSigned}}, or from {{unsignedMin}} to {{unsignedMax}} (unsigned experiment).':
      'Die Art muss eine ganze Zahl von 0 bis   PH0   oder von   PH1   bis   PH2   (unsigniertes Experiment) sein.',
    ...
    nostrSpecAffectedKindHint:
      'Eine Nostr-Nummer pro Zeile. Jede Zeile wird zu einem eigenen k-Tag.',
    ...
    'No publication events found for rebroadcast':
      'Keine Publikationsveranstaltungen für Rebroadcast gefunden',
    'No publication events were accepted by any relay':
      'Keine Publikationsereignisse wurden von einem Relais akzeptiert',
    'Note type': 'Anmerkungstyp',
    'Offline mode': 'Offline-Modus',
    'Only local relays and cached content are available.':
      'Nur lokale Relais und zwischengespeicherte Inhalte sind verfügbar.',
    ...
    'Proof of work is not supported for unsigned experimental kinds ({{min}}–{{max}}).':
      'Der Arbeitsnachweis wird für nicht signierte experimentelle Typen (  PH0  –  PH1  ) nicht unterstützt.',
    ...
    'Set kind, content, and tags, then publish.':
      'Art, Inhalt und Tags festlegen und dann veröffentlichen.',
    'Short Note': 'Short Note',
    'Signed: 0–{{maxSigned}}. Unsigned experiment (empty sig): {{unsignedMin}}–{{unsignedMax}}.':
      'Signiert: 0–  PH0  . Unsigniertes Experiment (leere Sig):   PH1  –  PH2  .',
    ...
    'This action is only available for publications':
      'Diese Aktion ist nur für Publikationen verfügbar',
    ...
    'Unsigned experimental kind: `sig` will be empty at publish; `id` is still the standard event hash. Not accepted by normal relays. Relays that allow this should authenticate you (e.g. NIP-42 AUTH) before writes.':
      'Unsignierte experimentelle Art: `sig` wird beim Veröffentlichen leer sein; `id` ist immer noch der Standard-Ereignis-Hash. Von normalen Relais nicht akzeptiert. Relais, die dies ermöglichen, sollten Sie authentifizieren (z. B. NIP-42 AUTH), bevor Sie schreiben.',
    ...
    profileEditorImageUrlHint:
      'Wird in Kind-0-Tags als picture oder banner gespeichert. Sie können einen Link von einem früheren Upload einfügen, statt den Uploader oben zu verwenden.',
    profileEditorNostrBuildThumbHint: 'nostr.build-Thumbnail-URL verwenden (/thumb/…)',
    profileEditorProfileNotLoaded:
      'Profil nicht geladen. Versuchen Sie, den Cache zu aktualisieren.',
    profileEditorTagListHint:
      'Alle Profilfelder als Tags. Zeilen zum Sortieren ziehen; die Tag-Reihenfolge wird beim Veröffentlichen gespeichert. Das erste jedes bekannten Felds füllt auch das Content-JSON.',
    'readOnlySession.hint':
      'Sie sind nur mit einem öffentlichen Schlüssel (npub) angemeldet. Veröffentlichen und Signieren sind in diesem Browser deaktiviert.',
    ...
    'paytoEditor.jsonPreviewHint':
      'Live-Vorschau des Kind-10133-Events, das veröffentlicht wird. Die Payto-Tag-Reihenfolge entspricht der Liste oben.',
    ...
    'Audio URL': 'Audio-URL',
    'Change the note text before submitting a suggestion.':
      'Ändern Sie den Notiztext, bevor Sie einen Vorschlag einreichen.',
    ...
    'Collaborative edit proposals (NIP-41). Accepting publishes your signed edit with the proposer’s text.':
      'Collaborative Edit Proposals (NIP-41). Accepting veröffentlicht Ihre signierte Bearbeitung mit dem Text des Antragstellers.',
    'Comma-separated genre tags (kind 36787 also adds t=music automatically)':
      'Comma-getrennte Genre-Tags (Art 36787 fügt auch automatisch t=music hinzu)',
    ...
    'Edit note': 'Anmerkung bearbeiten',
    ...
    'Fill required discussion thread fields':
      'Füllen Sie die erforderlichen Diskussions-Threadfelder aus',
    ...
    'NIP-41 author edit (kind 1010); your original note stays on relays.':
      'NIP-41 Author Edit (Art 1010); Ihre ursprüngliche Notiz bleibt auf Relais.',
    ...
    'Plain Lightning payments do not create NIP-57 zap receipts on Nostr. Use the zap button when available.':
      'Plain Lightning Zahlungen erstellen keine NIP-57 Zap Quittungen auf Nostr. Verwenden Sie den Zap-Button, wenn verfügbar.',
    'Propose a change to this note (NIP-41). The author can accept it by publishing their own edit with your text.':
      'Eine Änderung dieser Anmerkung vorschlagen (NIP-41). Der Autor kann es akzeptieren, indem er seine eigene Bearbeitung mit Ihrem Text veröffentlicht.',
    ...
    'Publish audio with cover art and lyrics (kind 36787)':
      'Veröffentlichen Sie Audio mit Cover-Art und Lyrics (Art 36787)',
    'Publishing…': 'Veröffentlichen..',
    'Revise your note; publishes a NIP-41 edit without replacing the original.':
      'Überarbeiten Sie Ihre Notiz; veröffentlicht eine NIP-41-Bearbeitung, ohne das Original zu ersetzen.',
    ...
    'Use the editor below for lyrics or notes (Markdown).':
      'Verwenden Sie den Editor unten für Lyrics oder Notizen (Markdown).',
    ...
    'readOnlySession.cannotPublish':
      'Im Nur-Lesen-Modus kann nicht veröffentlicht werden. Melden Sie sich mit einem privaten Schlüssel oder Signierer an.',
