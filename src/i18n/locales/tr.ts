export default {
  translation: {
    ...
    "Your donation helps me maintain Imwald and make it better! 😊": "Your donation helps me maintain Imwald and make it better! 😊",
    ...
    "Session relays tab description": "Relay logic for this session: working and striked preset relays, and scored random relays (used to prefer faster, proven relays when adding random relays to publish). Striked relays are skipped for reads and publishes until reload.",
    "Session relays preset working": "Working preset relays",
    "Session relays preset working hint": "Preset relays (from app defaults) that have not reached the session failure threshold (2 failures).",
    ...
    Balance: "Balance",
    characters: "characters",
    translateApiKeyDescription: "You can use this API key anywhere else that supports LibreTranslate. The service URL is {{serviceUrl}}",
    "Top up": "Top up",
    ...
    "After changing emojis, you may need to refresh the page": "After changing emojis, you may need to refresh the page",
