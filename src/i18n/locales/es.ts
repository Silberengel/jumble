export default {
  translation: {
    ...
    calendarNip52DayIndicesHint: "Las etiquetas D de NIP-52 marcan días civiles UTC enteros (índice de día Unix) para consultar eventos con hora; varios valores cubren un rango de varios días.",
    ...
    "Select the relay sets you want to pull": "Selecciona los conjuntos de relés que deseas recibir",
    ...
    "read relays description": "Los relés de lectura se usan para consultar eventos sobre ti. Otros usuarios publican eventos que deseas ver en tus relés de lectura.",
    "write relays description": "Los relés de escritura se usan para publicar tus eventos. Otros usuarios consultan tus eventos desde tus relés de escritura.",
    "read & write relays notice": "El número de servidores de lectura y escritura debería mantenerse idealmente entre 2 y 4.",
    "Tor & I2P": "Tor & I2P",
    ...
    "Enter the password to decrypt your ncryptsec": "Introduce la contraseña para descifrar tu ncryptsec",
    Back: "Volver",
    ...
    "Show this category expanded on payment method lists; other categories collapse behind an accordion.": "Muestra esta categoría expandida en las listas de métodos de pago; las demás se pliegan en un acordeón.",
    ...
    "Are you sure you want to unfollow this user?": "¿Estás seguro de que deseas dejar de seguir a este usuario?",
    "Seen on": "Visto en",
    ...
    "Failed to republish to your write relays: {{error}}": "Error al republicar a tus relés de escritura: {{error}}",
    "Successfully republish to relay set: {{name}}": "Republicado con éxito al conjunto de relés: {{name}}",
    "Failed to republish to relay set: {{name}}. Error: {{error}}": "Error al republicar al conjunto de relés: {{name}}. Error: {{error}}",
    "Successfully republish to relay: {{url}}": "Republicado con éxito al relé: {{url}}",
    "Failed to republish to relay: {{url}}. Error: {{error}}": "Error al republicar al relé: {{url}}. Error: {{error}}",
    "Write relays": "Relés de escritura",
    "n more boosts": "{{count}} more boosts",
    FollowListNotFoundConfirmation: "Lista de seguidos no encontrada. ¿Quieres crear una nueva? Si has seguido usuarios antes, por favor NO confirmes ya que esta operación te hará perder tu lista de seguidos anterior.",
    MuteListNotFoundConfirmation: "Lista de silenciados no encontrada. ¿Quieres crear una nueva? Si has silenciado usuarios antes, por favor NO confirmes ya que esta operación te hará perder tu lista de silenciados anterior.",
    ...
    "Your current relay configuration may not be optimal. This could make it difficult for others to find your posts and may result in incomplete notifications.": "Tu configuración actual de relés puede no ser óptima. Esto podría hacer que sea difícil para otros encontrar tus publicaciones y puede resultar en notificaciones incompletas.",
    ...
    "Write a review and pick a star rating": "Escriba una reseña y elija una calificación de estrellas",
    Submit: "Enviar",
