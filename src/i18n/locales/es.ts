export default {
  translation: {
    ...
    "Reply to": "Responder a",
    Search: "Buscar",
    "The relays you are connected to do not support search": "Los relés a los que estás conectado no soportan la búsqueda",
    ...
    "A special note for picture-first clients like Olas": "Una nota especial para clientes que priorizan imagen, como Olas",
    ...
    "This is a private key. Do not share it with anyone. Keep it safe and secure. You will not be able to recover it if you lose it.": "Esta es una clave privada. No la compartas con nadie. Guárdala de forma segura, ya que no podrás recuperarla si la pierdes.",
    Edit: "Editar",
    Save: "Guardar",
    ...
    "If enabled, you can zap with a single click. Click and hold for custom amounts": "Si está habilitado, puedes enviar un zap con un solo clic. Haz clic y mantén pulsado para cantidades personalizadas",
    All: "Todo",
    ...
    "Your donation helps me maintain Imwald and make it better! 😊": "¡Tu donación me ayuda a mantener y mejorar Imwald! 😊",
    ...
    "Only show content from your followed users and the users they follow": "Solo mostrar contenido de tus usuarios seguidos y los usuarios que ellos siguen",
    ...
    translateApiKeyDescription: "Puedes usar esta clave API en cualquier otro lugar que soporte LibreTranslate. La URL del servicio es {{serviceUrl}}",
    "Top up": "Recargar",
    ...
    "Are you sure you want to reset your API key? This action cannot be undone.": "¿Estás seguro de que deseas restablecer tu clave API? Esta acción no se puede deshacer.",
    Warning: "Advertencia",
    "Errors & warnings": "Errors & warnings",
    "Your current API key will become invalid immediately, and any applications using it will stop working until you update them with the new key.": "Tu clave API actual se volverá inválida de inmediato, y cualquier aplicación que la use dejará de funcionar hasta que las actualices con la nueva clave.",
    ...
    "Trusted users include people you follow and people they follow.": "Los usuarios confiables incluyen a las personas que sigues y a las personas que ellos siguen.",
    Continue: "Continuar",
    ...
    "You need to add at least one blossom server in order to upload media files.": "Necesitas agregar al menos un servidor Blossom para poder cargar archivos multimedia.",
    ...
    "Unlike regular notes, polls are not widely supported and may not display on other clients.": "A diferencia de las notas regulares, las encuestas no son ampliamente compatibles y pueden no mostrarse en otros clientes.",
    ...
    "After changing emojis, you may need to refresh the page": "Después de cambiar los emojis, es posible que necesites actualizar la página",
    "Too many read relays": "Demasiados relés de lectura",
    "Too many write relays": "Demasiados relés de escritura",
    "You have {{count}} read relays. Most clients only use 2-4 relays, setting more is unnecessary.": "Tienes {{count}} relés de lectura. La mayoría de los clientes solo usan 2-4 relés, configurar más es innecesario.",
    "You have {{count}} write relays. Most clients only use 2-4 relays, setting more is unnecessary.": "Tienes {{count}} relés de escritura. La mayoría de los clientes solo usan 2-4 relés, configurar más es innecesario.",
    ...
    "Deletion request sent to {{count}} relays": "Solicitud de eliminación enviada a {{count}} relés",
