...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // Match Dialog overlay (z-[200]) so alerts are not trapped under open dialogs.
...
const AlertDialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content> & {
    /** Optional overlay className (e.g. z-[250] so this alert appears above an open dialog). */
